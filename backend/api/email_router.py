...
def send_email_via_smtp(
    ...
    if not sender_email or not sender_password:
        ...
        return False, (
            ...
            "(EMAIL_SENDER_EMAIL + SMTP_SENDER_PASSWORD) and Brevo API fallback is unavailable"
        )
...
def send_email(req: SendEmailRequest):
    ...
    try:
        ...
        return {
            "success": True,
            "message": "Email has been queued for background delivery",
            "recipient_email": req.recipient_email,
        }
    except Exception as e:
...
def send_shortlist_email(req: BrevoSendRequest):
    ...
    if not brevo_api_key or brevo_api_key == "your-real-brevo-api-key-here" or brevo_api_key == "your-brevo-api-key-here":
        return {
            "success": False,
            "message": "Brevo API key is not configured. Update .env or pass brevo_api_key in the request.",
            "recipient_email": candidate_email,
            "recipient_name": candidate_name,
        }
